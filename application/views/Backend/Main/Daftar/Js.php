...
<!-- daterangepicker -->
<script src="<?php echo base_url("assets/Backend/js/wizard/jquery.smartWizard.js");?>"></script>
...
<script src="<?php echo base_url("assets/Backend/js/moment/moment.min.js");?>"></script>
<script src="<?php echo base_url("assets/Backend/js/datepicker/daterangepicker.js");?>"></script>
...
<script src="<?php echo base_url("assets/Backend/js/parsley/parsley.min.js");?>"></script>
<script src="<?php echo base_url("assets/Backend/js/textarea/autosize.min.js");?>"></script>
<script src="<?php echo base_url("assets/Backend/js/autocomplete/countries.js");?>"></script>
<script src="<?php echo base_url("assets/Backend/js/autocomplete/jquery.autocomplete.js");?>"></script>
